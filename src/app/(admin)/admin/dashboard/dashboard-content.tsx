...
export default function DashboardContent({ stats, recentBookings, categoryDistribution }: DashboardContentProps) {
                ...
                {recentBookings.length === 0 ? (
                  ...
                  recentBookings.map((booking) => (
                    ...
                    >
                      ...
                      <td className="py-4">
                        <span className={cn(
                          "px-2 py-1 text-[9px] font-bold uppercase tracking-widest rounded-full",
